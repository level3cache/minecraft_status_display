...
execute unless score @s l3_afk.x2 = @s l3_afk.x1 run team leave @s
execute unless score @s l3_afk.y2 = @s l3_afk.y1 run team leave @s
execute unless score @s l3_afk.z2 = @s l3_afk.z1 run team leave @s
