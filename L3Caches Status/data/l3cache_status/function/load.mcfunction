...
team modify l3_status.bambus suffix [{"text":" [","color":"white"},{"text":"B","color":"dark_green"},{"text":"a","color":"green"},{"text":"m","color":"dark_green"},{"text":"b","color":"green"},{"text":"u","color":"dark_green"},{"text":"s","color":"green"},{"text":"]","color":"white"}]
